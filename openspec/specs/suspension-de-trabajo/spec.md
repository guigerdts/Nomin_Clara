...
#### Scenario: First suspension at the eight-day threshold warns nothing
- **WHEN** a first disciplinary suspension lasts exactly 8 días
- **THEN** no excess warning is shown

#### Scenario: First suspension beyond eight days warns
- **WHEN** a first disciplinary suspension lasts 9 días
- **THEN** the Art. 112 excess warning is shown

#### Scenario: Reincidencia at the sixty-day threshold warns nothing
- **WHEN** a reincidencia lasts exactly 60 días
- **THEN** no excess warning is shown

#### Scenario: Reincidencia beyond sixty days warns
- **WHEN** a reincidencia lasts 61 días
- **THEN** the Art. 112 excess warning is shown

#### Scenario: Non-disciplinary causales never show the field
